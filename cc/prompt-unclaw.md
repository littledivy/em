...
6. After the orchestrator opens the PR, your session will be killed. Don't watch CI yourself — the orchestrator polls every tick and re-engages you (via `claude --continue`) on CI failure, reviewer comment, or merge conflict.
